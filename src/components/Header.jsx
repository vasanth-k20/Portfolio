            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="hidden md:flex space-x-8 items-center">
                        <a href="#home" className="px-2 text-[1.2em] hover:text-amber-400 transition-all duration-300 transform hover:translate-y-1">
                            Home
                        </a>
            ...
            {isOpen && (
                ...
                <div className="flex justify-end p-4">
                    ...
                    <div className="flex flex-col items-center space-y-6 py-8">
                        <a href="#home" onClick={() => setIsOpen(false)} className="text-xl sm:text-2xl text-white hover:text-amber-400 transition-transform transform hover:scale-105">
                            Home
                        </a>
